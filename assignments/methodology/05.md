...
## Latex, Markdown and Github Pages + Methodology Assignment 4
{: .no_toc }
...
{: .red }
**There are two "tasks" for Methodology Assignment 4, one for each part. You should submit your work for both tasks to the Methodology Assignment 4 portal on Gradescope by Monday, Nov 10th at 11:59PM. Post questions with the assignment on Piazza. Avoid last minute questions OR submissions.**
...
<center><img src="https://dsc-capstone.org/2025-26/assignments/methodology/assets/overleaf-first-example.png" width="80%"><br><i>The Overleaf UI.</i></center>
...
Once you have an Overleaf account, you'll need to create a new blank project for the Methodology Assignment. To do so, you can go to [overleaf.com/projects](https://overleaf.com/projects), click "New Project" in the top left, and then click "Blank Project." Enter "DSC 180A Methodology Assignment 4" as the project name. You'll be brought to an environment that looks just like this one:

<center><img src="https://dsc-capstone.org/2025-26/assignments/methodology/assets/ma4-base.png" width="80%"><br><i>A blank project titled "DSC 180A Methodology Assignment 4."</i></center>

As you enter text on the left in `main.tex`, you can hit `Control`/`Command` + `Enter` to re-render the PDF corresponding to `main.tex`. Keep this project open in a separate tab, you'll need to come back to it [below](#methodology-assignment-4-tasks).
...
As mentioned above, the template mostly exists for style purposes. Not all headings provided in the template will actually be useful for you; you can add or remove headings as you please, and the headings you end up using are up to you and your mentor. Look to the "Anatomy of a Scientific Paper" section of [Methodology Lesson 4](https://dsc-capstone.org/2025-26/lessons/04/#anatomy-of-a-scientific-paper) for guidance on which headings to use. Additionally, the top of the template asks you to put links to a website and code; for your Quarter 1 Project, you won't link a website, but will link your code; for your Quarter 2 Proposal, you won't link either of these; for your actual Quarter 2 Project, you'll link both of these.
...
### Methodology Assignment 4, Task 1

The first task in this Methodology Assignment is to **re-create the PDF below** in the blank project named "DSC 180A Methodology Assignment 4" you created [above](#ma4-template). You should do this **individually.**

<center><img src="https://dsc-capstone.org/2025-26/assignments/methodology/assets/ma4-target.png" width="100%"></center>
...
- In Section 3, you can either use [this picture](https://dsc-capstone.org/2025-26/assignments/methodology/assets/junior.png) and include the picture of a dog, Junior, or use a different picture of your own pet/favorite animal. If you use a picture of a different animal, replace the two bullet points about Junior with two bullet points about your chosen animal.
...
Once you're done, download your PDF by clicking the following button.
 ...
 <center><img src="https://dsc-capstone.org/2025-26/assignments/methodology/assets/download.png" width="20%"></center>

{: .red }
**Once you're ready to submit, upload both your `main.tex` and PDF to Task 1 in the "Methodology Assignment 4" portal on Gradescope.**
...
<center>
<iframe src="https://dsc-capstone.org/2025-26/assignments/methodology/assets/example-map.html" width=800 height=600 frameBorder=0></iframe>
</center>
...
- Each project you create can have a project website, published at `<username>.github.io/<reponame>`.
    - For instance, the site for the repository [github.com/dsc-capstone/showcase-24](https://github.com/dsc-capstone/showcase-24) is hosted at [dsc-capstone.github.io/showcase-24](https://dsc-capstone.github.io/showcase-24), and because [dsc-capstone.github.io](https://dsc-capstone.github.io) uses the custom domain name [dsc-capstone.org](https://dsc-capstone.org), this appears as [dsc-capstone.org/showcase-24](https://dsc-capstone.org/showcase-24).
...
To see the source code for a more complicated Jekyll site, in addition to looking at [last year's capstone websites](https://dsc-capstone.org/showcase-24), you can look at the [source code for dsc-capstone.github.io](https://github.com/dsc-capstone/dsc-capstone.github.io). 
...
The second task in Methodology Assignment 4 is to create a barebones static website using GitHub Pages and Jekyll, and use it to answer a few questions. You'll do this individually.

First, create a public repository named `DSC180A-Methodology-4`. Then, using the instructions above, enable GitHub Pages for your site, using Jekyll. Add a `_config.yml` file for the site that specifies the theme that you'd like.
...
{: .red }
**Once you're ready to submit, upload both a link to your _public_ website and your `index.md` to Task 2 in the "Methodology Assignment 4" portal on Gradescope.**
