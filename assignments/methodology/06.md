...
# 🛠 Environments and Containerization + MA 5
{: .no_toc }


{: .green }
**Like earlier, this week's Methodology Lesson and Methodology Assignment are combined into a single document, structured as a tutorial. The part that needs to be submitted is marked  clearly below.** 
...
<center><img src="https://dsc-capstone.org/2025-26/assignments/methodology/assets/flowchart.png" width="60%"><br>
...
Here is a [**🎥 video**](https://youtu.be/5Z-Cu4_SJg8) that walks through most of the relevant steps.
...
```
launch.sh -i ghcr.io/ubellur/dsc-example-docker-image -W DSC180A_FA25_A00
```
