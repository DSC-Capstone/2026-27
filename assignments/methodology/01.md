...
Before attempting this assignment, make sure to read [Lesson 1](https://dsc-capstone.org/2026-27/lessons/01/) – it will be significantly more time-consuming if you don't read the lesson and watch the associated video first. Submit this assignment to Gradescope no later than **Monday, October 6th at 11:59PM**. Post questions with the assignment on Piazza.
