...
Just as you're required to with your [Quarter 1 Project](https://dsc-capstone.org/2025-26/assignments/projects/q1), you'll be required to submit a contributions statement along with your Quarter 2 Project at the end of Quarter 2. Last year, we saw several cases where a student in a group contributed a single-digit percentage of the overall work done by the project group, and those students' scores suffered. **One of the main purposes of the proposal is to avoid instances of this!**
...
- A **6-7 week** schedule with tasks and goals to be accomplished each week by each person. This needs to be a matrix of people of one axis and time on another axis. Each cell contains the deliverable for that person for the week in question. 
...
**Why a 6-7 week schedule in a 10 week quarter?**
...
- Elevator Pitch.
  ...
  - Must present dry run during your group's [Week 9/10 TA Check-In](https://dsc-capstone.org/2025-26/assignments/projects/q1-week-9-10-checkin).
